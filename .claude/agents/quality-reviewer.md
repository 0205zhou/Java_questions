...
6. **Personal questions extra check**: if the answer involves personal experience (自我介绍/项目经历/实习经历), verify it is consistent with the resume at `${CLAUDE_SKILL_DIR}/references/resume/resume.md`. Any fabricated project name, company, metric, or award = automatic FAIL.
